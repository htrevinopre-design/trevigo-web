...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/tecnologia`,        lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/coatingai`,         lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/surfaceos`,         lastModified: now, changeFrequency: "monthly", priority: 0.75 },
